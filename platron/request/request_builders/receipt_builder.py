...
class ReceiptBuilder(RequestBuilder):
    ...
    def __init__(self, operation_type, payment_id = None, order_id = None):
        ...
        Args:
            operation_type (string): operation type transaction|refund|moneyback
    ...
    def add_item(self, item):
        ...
        self.items_params.update(item.get_params())
    
    def __get_operstion_types(self):
        return dict.fromkeys(['transaction', 'refund', 'moneyback'])